...
::: {.trace-step}
**Iteration 0:** `forecast-series` compares ARIMA and Theta. Metrics pick Theta, but the figure shows drift and the report flags a short validation window.
:::

::: {.trace-step}
**Iteration 1:** run decomposition + a wider baseline set, update the forecasting skill to check residual drift, and add a rubric for report quality before reranking.
:::
