...
lower-level `tool run` path below when you want a machine-readable record of a
plot-producing tool response:
...
longer embed plots; use `workflow run forecast-series --output-dir ...` when
you want forecast PNG/CSV/report artifacts.
